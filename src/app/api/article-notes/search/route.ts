...
export async function POST(req: Request) {
  ...
  // match_article_notes predates the `source` column and doesn't filter by
  // it — post-filter here so semantic search can't leak daily_auto rows into
  // a source-scoped view (e.g. manual "Mine" saves).
  let results = data ?? []
