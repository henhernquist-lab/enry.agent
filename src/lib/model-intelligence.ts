...
const BENCHMARK_DATA: Record<string, ModelBenchmark> = {
  ...
  'grok-4': {
    ...
    categories: [
      ...
      { category: 'instructionFollowing', score: 84 },
      { category: 'latency', score: 72 },
      { category: 'costEfficiency', score: 58 },
      { category: 'reliability', score: 92 },
      { category: 'jsonStructured', score: 84 },
    ],
    avgLatencyMs: 3800,
    avgTokensPerSec: 0,
    avgCostPerMTokens: 3.0,
    estimatedCostPerMTokens: 3.0,
    contextWindow: 131_072,
    successRate: 94,
    lastBenchmarkedAt: '2026-07-24T08:00:00Z',
    benchmarkCount: 1,
    provider: 'xAI',
    runId: 'static',
  },
