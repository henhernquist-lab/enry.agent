...
const BENCHMARK_DATA: Record<string, ModelBenchmark> = {
  ...
  'grok-4.5': {
    ...
    categories: [
      { category: 'coding', score: 84 },
      { category: 'reasoning', score: 83 },
      { category: 'math', score: 82 },
      ...
      { category: 'costEfficiency', score: 66 },
      { category: 'reliability', score: 92 },
      { category: 'jsonStructured', score: 82 },
    ],
    avgLatencyMs: 2500,
    avgTokensPerSec: 0,
    avgCostPerMTokens: 0.35,
